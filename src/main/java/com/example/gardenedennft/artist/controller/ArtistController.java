package com.example.gardenedennft.artist.controller;
...
public class ArtistController {
    ...
    public ResponseEntity<ArtistResponse> getAllArtistsByCondition(@RequestParam String name, @RequestParam String symbol){
